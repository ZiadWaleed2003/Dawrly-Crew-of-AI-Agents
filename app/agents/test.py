...
crew = Crew(
    ...
    tasks=[job_analyst_agent.create_task(
        user_input="I want a .net and C# developer role in Egypt you can use Indeed or Linkedin my experience is 0 years so you must look for fresh rules or juniors!",
    )],
    verbose=1
)
